# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 17:12:00 2021
...
def premodels(pretrained,model_selec,num_classes):
    ...
    if model_selec=="ResNetm":
        ...
        model_t._fc = nn.Sequential(nn.Linear(1280, 256),
                                  nn.Dropout(0.5),
                                  nn.ReLU(True),
    ...
    return model
model_list=["SENet","MobileNet","VGG11"]
# for model_name in model_list:
#   model1=premodels(pretrained=True,model_selec=model_name,num_classes=3) 
#   inp=torch.rand(1,3,224,224)
#   out=model1(inp)
#   print(out.shape)
#   print(model_name)
for model_name in model_list:
    model=premodels(pretrained=True,model_selec=model_name,num_classes=3)
    model.cuda()
